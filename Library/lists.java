...
public class lists {
    public static void main(String[] args) {
        ...
        adlar.add("Mehmet");
        System.out.println(adlar);
        System.out.println(adlar.get(1));
        System.out.println(adlar.getFirst());
        adlar.add(1, "Nurten");
        System.out.println(adlar);
        adlar.add(1, "Nursen");
        */
        ...
        boolean durum = adlar.remove("Ali");
        System.out.println("Durum : " + durum + " Liste " + adlar);
        ...
        */
        ...
        List<Integer> sayilar = Arrays.asList(10,1,-20,40,5,5,-23,0);
        ...
        System.out.println("Ortalamasi : " + (toplam/sayilar.size()));
